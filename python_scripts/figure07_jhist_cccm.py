...
def plot_jhist_cccm():
    ...
    plt.tight_layout()
    print("saving as ../plots/figure07_jhist_cccm.png")
    plt.savefig("../plots/figure07_jhist_cccm.png".format(region),dpi=200)
    plt.show()
...
def plot_jhist_schematic():
    ...
    # ax.set(xlim=[0,1])
    plt.savefig("../plots/extra_figure_jhist_schematic.png")
    plt.show()
