...
FILE_PATH=/scratch/b/b380883/dyamond2/SAM/GT

declare -a RadFileArray=(rlt)
# olr (J/m2 --> W/m2)
for v in "${RadFileArray[@]}"; do
    cdo -divc,900 -deltat $FILE_PATH/GT_SAM_${v}acc_20200120-20200229.nc $FILE_PATH/GT_SAM_${v}_20200120-20200229.nc
#     cdo -chname,rltacc,rlt -chunit,"J/m2","W/m2" $FILE_PATH/GT_SAM_${v}_20200120-20200229.nc $FILE_PATH/GT_SAM_${v}_20200120-20200229.nc
    ncatted -O -a standard_name,rltacc,o,c,"toa_net_downward_longwave_flux" -a long_name,rltacc,o,c,"Net LW at TOA" -a units,rltacc,o,c,"W/m2" $FILE_PATH/GT_SAM_${v}_20200120-20200229.nc
    ncrename -O -v rltacc,rlt $FILE_PATH/GT_SAM_${v}_20200120-20200229.nc
done
